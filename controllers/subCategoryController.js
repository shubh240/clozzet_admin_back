...
export const createSubcategory = async (req, res) => {
  try {
    const { name, category, isReturn } = req.body;
    ...
    if (typeof isReturn !== "undefined") {
      if (isReturn == "true") {
        newSubcategoryData.isReturn = true;
      } else if (isReturn == "false") {
        newSubcategoryData.isReturn = false;
      }
    }
...
export const updateSubcategory = async (req, res) => {
  try {
    ...
    if (typeof isReturn !== "undefined") {
      if (isReturn == "true") {
        subcategory.isReturn = true;
      } else if (isReturn == "false") {
        subcategory.isReturn = false;
      }
    }
